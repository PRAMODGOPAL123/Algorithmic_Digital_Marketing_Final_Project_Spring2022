import pickle
import pandas as pd
group_association_rules_dic = pickle.load(open("./pickle_files/grouped_association_rules_dic.p", "rb"))
products = pd.read_csv("./csv_files/products.csv")
clustered_users = pickle.load(open("./pickle_files/clustered_users.p", "rb"))
